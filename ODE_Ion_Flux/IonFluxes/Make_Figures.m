...
% Also V_m and osmotic pressure are plotted.
...
set(hleg1, 'position' , [0.1 0.85 0.4 0.17])
...
% Subplot V_m
subplot(3 , 1 , 2)
plot(v.Z * 1e3 , v.V_m * 1e3 , 'blue' , 'LineWidth' , 3)
...
% Subplot Osmotic  pressure
subplot(3 , 1 , 3)
plot(v.Z * 1e3 , v.OP / 1e2 , 'blue' , 'LineWidth' , 3)

grid on

x_label = xlabel('Intracellular Non Permeable Anions [mM] ');
y_label = ylabel({'Osmotic' ; 'Pressure [atm]'});
